...
$potencia_placa = 560; //Ajustar para puxar do front/banco posteriormente.
$tensao_placa = 50.6; //Ajustar para puxar do front/banco posteriormente.
$corrente_placa = 14.06; //Ajustar para puxar do front/banco posteriormente.
$quantidade_placa = 1;
$quantidade_string = 1;

$potencia_sistema = $potencia_placa * $quantidade_placa;

$tensao_banco_bateria = 24; //Ajustar para puxar do front/banco posteriormente.
$profundidade_descarga = 0.8; //Ajustar para puxar do front/banco posteriormente.
$autonomia_dias = 2; //Ajustar para puxar do front/banco posteriormente.


$corrente_bateria = 7; //Ajustar para puxar do front/banco posteriormente.
$tensao_bateria = 12; //Ajustar para puxar do front/banco posteriormente.
...
$corrente_consumida_equipamentos = $potencia_total_item / $tensao_banco_bateria;
